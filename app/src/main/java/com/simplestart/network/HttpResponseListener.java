...
//            mWaitDialog = new XXDialog(activity, R.layout.activity_custom_loding_dialog_layout) {
//                @Override
//                public void convert(DialogViewHolder holder) {
//                    GifView gifView = (GifView) holder.getView(R.id.image_loading);
...
//            mWaitDialog.showDialog();
        Log.e("log","HttpResponseListener onStart..."+what);
    }
